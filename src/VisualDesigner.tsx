                      ...
                      >
                        ...
                        >
                          ...
                          <div>
                            ...
                            >
                              I'm a B.Tech student in Data Science & AI
                              (2023–2027) at IFHE Hyderabad, with hands-on
                              production experience building AI/ML systems, LLM
                              pipelines, and full-stack applications well before
                              graduation. At Viswam.AI, I contributed to India's
                              first large-scale Telugu LLM — working directly on
                              data collection, corpus refinement, and supervised
                              fine-tuning inside a Linux-based NLP pipeline. At
                              Mindenious Edutech, I completed an Azure Cloud
                              Computing program spanning compute, networking,
                              storage, and security, delivering a capstone cloud
                              deployment. Earlier, at Seponty, I translated user
                              requirements into interaction patterns for a
                              production chatbot application as a UI/UX intern.
                            </p>
                            ...
                            >
                              ...
                              mindset — a credit risk platform with an ensemble
                              ML model and SHAP explainability, a multi-agent
                              workflow engine with self-healing failure
                              recovery, an AI-powered retail system with
                              blockchain-signed receipts, and a medical
                              assistant with full RAG grounding on personal
                              health records. Beyond the work, I'm a national
                              hackathon finalist, a Top 20 team pick at
                              TechSprint nationwide, and part of the team that
                              built a real-time voice-first AI banking assistant
                              at the Agentathon 2025 Guinness World Record
                              event.
                            </p>
                            ...
                            >
                              ...
                              emerging technologies, contributing to open-source
                              projects, or crafting pixel-perfect interfaces. I
                              believe in the power of clean code, thoughtful
                              design, and solving complex problems with elegant
                              solutions. I'm actively seeking internships and
                              full-time roles in AI/ML engineering, LLM
                              development, and full-stack AI — and ready to
                          ...
                          >
                            ...
                            >
                              ...
                              >
                                Crafting ensemble models, explainable
                                predictions, and end-to-end ML pipelines.
                              </p>
                              <div
                                style={{
                                  display: "grid",
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      networking protocols, managing elastic compute resources,
                      and implementing zero-trust security patterns across
                  ...
                  >
                    ...
                    >
                      Pioneered a specialized Telugu LLM initiative in
                      Hyderabad. Engineered comprehensive NLP inference
                      pipelines and curated high-quality datasets for regional
                      language modeling, pushing the boundaries of localized AI
                      communication.
                    </p>
                  </div>
                  ...
                  >
                    ...
                    >
                      ...
                      chatbot. Focused on reducing cognitive load through
                      refined conversational UI components and creating
                      intuitive user journeys within the digital ecosystem.
                    </p>
                  </div>
                </div>
              </div>
                  ...
                  <div style={{ marginBottom: 48 }}>
                    ...
                    >
                      ...
                      <button
                        ...
                        onClick={() =>
                          (window.location.href = "tel:+918074057617")
                        }
                      >
                        <svg
                          width="20"
                        ...
                        style={{
                          ...
                          backgroundColor:
                            formStatus === "success"
                              ...
                              : "rgba(244, 67, 54, 0.15)",
                          color:
                            formStatus === "success" ? "#4caf50" : "#f44336",
                          border:
                            formStatus === "success"
